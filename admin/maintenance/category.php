...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools" style="background-color: #6f42c1; color: white;">
			<a href="?page=maintenance/manage_category" class="btn btn-flat btn-primary" style="background-color: #6f42c1; color: white;"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
