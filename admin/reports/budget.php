    ...
    <div class="card-body">
        <form id="filter-form">
            <div class="row align-items-end">
                ...
                <div class="form-group col-md-1" style="background-color: #6a1b9a; color: white;" type="button" id="printBTN">
                    <button class="btn btn-flat btn-block btn-success btn-sm" type="button" id="printBTN" style="background-color: #6a1b9a; color: white;" type="button" id="printBTN"><i class="fa fa-print"></i> Print</button>
                </div>
            </div>
        </form>
        <hr>
