...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools" style="background-color: #6f42c1; color: white;">
			<a href="javascript:void(0)" id="manage_budget" class="btn btn-flat btn-sm btn-primary" style="background-color: #6f42c1; color: white;"><span class="fas fa-plus"></span>  Add New</a>
		</div>
	</div>
	<div class="card-body">
